...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het Casrodsoft Remote netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer Casrodsoft Remote op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u Casrodsoft Remote toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u Casrodsoft Remote toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u Casrodsoft Remote toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [Casrodsoft Remote Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep Casrodsoft Remote background service", "Casrodsoft Remote achtergronddienst behouden"),
        ...
        ("Show Casrodsoft Remote", "Toon Casrodsoft Remote"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ("Elevate", "Verhoog"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u Casrodsoft Remote toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u Casrodsoft Remote toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende Casrodsoft Remote."),
        ...
        ("verify_rustdesk_password_tip", "Bevestiging wachtwoord Casrodsoft Remote"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om Casrodsoft Remote te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Upgrade Casrodsoft Remote Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor Casrodsoft Remote mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het Casrodsoft Remote-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt Casrodsoft Remote op de achtergrond actief te houden"),
        ...
        ("About Casrodsoft Remote", "Over Casrodsoft Remote"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgrade de Casrodsoft Remote client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert Casrodsoft Remote het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat Casrodsoft Remote verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt Casrodsoft Remote niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de Casrodsoft Remote-server."),
