...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem Casrodsoft Remote..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, Casrodsoft Remote v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate Casrodsoft Remoteu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate Casrodsoft Remoteu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno Casrodsoft Remoteu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »Casrodsoft Remote Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep Casrodsoft Remote background service", "Ohrani Casrodsoft Remoteovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije Casrodsoft Remote, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "Casrodsoft Remote potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "Casrodsoft Remote potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za Casrodsoft Remote"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite Casrodsoft Remote, prekinite klic in program zaprite."),
        ("scam_text2", "Casrodsoft Remote omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite Casrodsoft Remote Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo Casrodsoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno Casrodsoft Remotea odprto"),
        ...
        ("floating_window_tip", "Pomaga pri Casrodsoft Remote storitvi v ozadju"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite Casrodsoft Remote odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto Casrodsoft Remote preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo Casrodsoft Remote ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, Casrodsoft Remote ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik Casrodsoft Remote OSS ne vključuje te funkcije."),
