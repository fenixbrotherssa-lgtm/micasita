...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Casrodsoft Remote może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować Casrodsoft Remote w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić Casrodsoft Remote przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić Casrodsoft Remote na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [Casrodsoft Remote Input]."),
        ...
        ("Language", "Język"),
        ("Keep Casrodsoft Remote background service", "Zachowaj usługę Casrodsoft Remote w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji Casrodsoft Remote, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show Casrodsoft Remote", "Pokaż Casrodsoft Remote"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji Casrodsoft Remote uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać Casrodsoft Remote uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z Casrodsoft Remote w Twojej sieci."),
        ...
        ("verify_rustdesk_password_tip", "Weryfikuj hasło Casrodsoft Remote"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu Casrodsoft Remote - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Proszę zaktualizować Casrodsoft Remote Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu Casrodsoft Remote po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez Casrodsoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno Casrodsoft Remote jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę Casrodsoft Remote w tle"),
        ...
        ("About Casrodsoft Remote", "O programie"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient Casrodsoft Remote do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie Casrodsoft Remote weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, Casrodsoft Remote pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, Casrodsoft Remote nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS Casrodsoft Remote nie obsługuje tej funkcji."),
