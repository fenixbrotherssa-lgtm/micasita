...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään Casrodsoft Remote verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa Casrodsoft Remote ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi Casrodsoft Remotein järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava Casrodsoft Remoteille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava Casrodsoft Remoteille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten Casrodsoft Remote daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota Casrodsoft Remoteille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli Casrodsoft Remote ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "Casrodsoft Remote palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa Casrodsoft Remotein asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "Casrodsoft Remote palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep Casrodsoft Remote background service", "Pidä Casrodsoft Remotein taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista Casrodsoft Remotein akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show Casrodsoft Remote", "Näytä Casrodsoft Remote"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista Casrodsoft Remote salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "Casrodsoft Remote ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä Casrodsoft Remote Server Pro versioon {} jatkaaksesi."),
        ...
        ("About Casrodsoft Remote", "Tietoa Casrodsoft Remoteistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-Casrodsoft Remote-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena Casrodsoft Remote vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, Casrodsoft Remote ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, Casrodsoft Remote ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: Casrodsoft Remote-palvelimen OSS ei sisällä tätä ominaisuutta."),
