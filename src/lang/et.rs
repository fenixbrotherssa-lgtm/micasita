...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Casrodsoft Remotei võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa Casrodsoft Remote mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et Casrodsoft Remote oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb Casrodsoft Remoteile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb Casrodsoft Remoteile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma Casrodsoft Remoteile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [Casrodsoft Remote Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep Casrodsoft Remote background service", "Säilita Casrodsoft Remotei taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele Casrodsoft Remotei rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show Casrodsoft Remote", "Kuva Casrodsoft Remote"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma Casrodsoft Remoteile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma Casrodsoft Remoteile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud Casrodsoft Remotei kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita Casrodsoft Remotei parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul Casrodsoft Remotei kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda Casrodsoft Remote Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib Casrodsoft Remoteil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb Casrodsoft Remoteil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui Casrodsoft Remotei aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada Casrodsoft Remotei taustateenust."),
        ...
        ("About Casrodsoft Remote", "Casrodsoft Remotei teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage Casrodsoft Remotei klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib Casrodsoft Remote TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab Casrodsoft Remote kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta Casrodsoft Remote enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: Casrodsoft Remotei serveri OSS ei sisalda seda funktsiooni."),
