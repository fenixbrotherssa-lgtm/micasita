...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Casrodsoft Remote..."),
        ...
        ("install_tip", "Do cơ chế UAC, Casrodsoft Remote có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt Casrodsoft Remote vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho Casrodsoft Remote."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho Casrodsoft Remote."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [Casrodsoft Remote Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep Casrodsoft Remote background service", "Giữ dịch vụ Casrodsoft Remote chạy nền"),
        ...
        ("Show Casrodsoft Remote", "Hiện Casrodsoft Remote"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu Casrodsoft Remote"),
        ...
        ("scam_text2", "Chỉ sử dụng Casrodsoft Remote với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ Casrodsoft Remote mở"),
        ...
        ("floating_window_tip", "Giữ Casrodsoft Remote trên cùng"),
        ...
        ("About Casrodsoft Remote", "Về Casrodsoft Remote"),
