...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Casrodsoft Remote network..."),
        ...
        ("install_tip", "Due to UAC, Casrodsoft Remote can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Casrodsoft Remote to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Casrodsoft Remote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Casrodsoft Remote \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Casrodsoft Remote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Casrodsoft Remote Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Casrodsoft Remote application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Casrodsoft Remote \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Casrodsoft Remote \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Casrodsoft Remote."),
        ...
        ("verify_rustdesk_password_tip", "Verify Casrodsoft Remote password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Casrodsoft Remote and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade Casrodsoft Remote Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Casrodsoft Remote from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Casrodsoft Remote window is open"),
        ...
        ("floating_window_tip", "It helps to keep Casrodsoft Remote background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Casrodsoft Remote client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Casrodsoft Remote verifies the server certificate for protocols using TLS.\nWith this option enabled, Casrodsoft Remote will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Casrodsoft Remote will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Casrodsoft Remote server OSS doesn't include this feature."),
