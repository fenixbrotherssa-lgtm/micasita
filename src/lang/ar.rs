...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة Casrodsoft Remote..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. Casrodsoft Remote قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت Casrodsoft Remote في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح Casrodsoft Remote اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح Casrodsoft Remote اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ Casrodsoft Remote باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [Casrodsoft Remote Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep Casrodsoft Remote background service", "ابق خدمة Casrodsoft Remote تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق Casrodsoft Remote, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show Casrodsoft Remote", "عرض Casrodsoft Remote"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من Casrodsoft Remote اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح Casrodsoft Remote اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في Casrodsoft Remote الذي يعمل."),
        ...
        ("verify_rustdesk_password_tip", "تحقق من كلمة مرور Casrodsoft Remote"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "ترقية خادم Casrodsoft Remote Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع Casrodsoft Remote"),
        ...
        ("About Casrodsoft Remote", "حول Casrodsoft Remote"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "ترقية عميل Casrodsoft Remote البعيد إلى {}"),
