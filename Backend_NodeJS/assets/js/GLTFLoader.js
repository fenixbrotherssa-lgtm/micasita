// =============================================================
// GLTFLoader.js - ADAPTADO PARA MEDIC SYSTEM CORE (SIN IMPORTS)
// =============================================================

const {
    AnimationClip, Bone, Box3, BufferAttribute, BufferGeometry,
    ClampToEdgeWrapping, Color, ColorManagement, DirectionalLight,
    DoubleSide, FileLoader, FrontSide, Group, ImageBitmapLoader,
    InstancedMesh, InterleavedBuffer, InterleavedBufferAttribute,
    Interpolant, InterpolateDiscrete, InterpolateLinear, Line,
    LineBasicMaterial, LineLoop, LineSegments, LinearFilter,
    LinearMipmapLinearFilter, LinearMipmapNearestFilter,
    LinearSRGBColorSpace, Loader, LoaderUtils, Material,
    MathUtils, Matrix4, Mesh, MeshBasicMaterial, MeshPhysicalMaterial,
    MeshStandardMaterial, MirroredRepeatWrapping, NearestFilter,
    NearestMipmapLinearFilter, NearestMipmapNearestFilter,
    NumberKeyframeTrack, Object3D, OrthographicCamera,
    PerspectiveCamera, PointLight, Points, PointsMaterial,
    PropertyBinding, Quaternion, QuaternionKeyframeTrack,
    RepeatWrapping, Skeleton, SkinnedMesh, Sphere, SpotLight,
    Texture, TextureLoader, TriangleFanDrawMode, TriangleStripDrawMode,
    Vector2, Vector3, VectorKeyframeTrack, SRGBColorSpace,
    InstancedBufferAttribute
} = THREE;

// Mock de utilidades para evitar dependencias de archivos externos
const toTrianglesDrawMode = function ( geometry, drawMode ) {
    if ( drawMode === TriangleFanDrawMode || drawMode === TriangleStripDrawMode ) {
        console.warn( 'THREE.GLTFLoader: toTrianglesDrawMode es una utilidad limitada en esta versión.' );
    }
    return geometry;
};
...
// ... (Aquí continúa el resto del código original de tu GLTFLoader.js)
/**
